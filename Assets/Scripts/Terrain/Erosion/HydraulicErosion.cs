...
public class HydraulicErosion : MonoBehaviour
{
        ...
        for (int it = 0; it < _iterations; it++)
        {
            for (int i = 0; i < _particleCount; i++)
            {
                ...
                for (int j = 0; j < _lifetime; j++)
                {
                    ...
                    float newHeight = CalculateHeight(d);
    ...
    private float CalculateHeight(Vector2 posdif, float[] corners)
    {
        float h00 = corners[0];
        float h10 = corners[1];
        float h01 = corners[2];
    ...
    private float CalculateHeight(Droplet d)
    {
        ...
        return CalculateHeight(posdif, corners);
    }
    ...
    private HeightAndGradient CalculateHeightAndGradient(Droplet d)
    {
        ...
        // calc height
        float height = CalculateHeight(posdif, corners);
